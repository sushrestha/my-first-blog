...
{
	var zero = ["It does not check the formatting of the information"];
	var one = ["It does not have a maximum length"];
	var two = ["None"];
	var three = ["It does not have a maximum length","It does not validate the information given"];
	var four = ["It does not validate the information given"];
	var five = ["None"];
	var six = ["None"];
	var seven = ["It does not check the formatting of the information"];
	var eight = ["It does not check the formatting of the information","It does not have a maximum length"];
	var nine = ["It does not check the formatting of the information"];
